...
public final class Api {
    ...
    /**
     * A POJO mirroring a JSON object with a set of urls of different sizes and dimensions returned for a single image from Giphy's api.
     */
    public static class GifUrlSet {
        ...
        @Override
        public String toString() {
            return "GifUrlSet{" + "original=" + original + ", fixed_width_downsampled=" + fixed_width_downsampled + ", fixed_height_downsampled=" +
                fixed_height_downsampled + '}';
        }
    }

    /**
     * A POJO mirroring a JSON object for an image with one particular url, size and dimension returned from Giphy's api.
     */
    public static class GifImage {
        ...
        @Override
        public String toString() {
            return "GifImage{" + "url='" + url + '\'' + ", width=" + width + ", height=" + height + ", frames=" + frames + ", size=" + size + '}';
        }
    }
}
