...
public class DrawableRequestBuilder<ModelType> extends GenericRequestBuilder<ModelType, ImageVideoWrapper, GifBitmapWrapper, GlideDrawable>
    ...
    DrawableRequestBuilder(Context context, Class<ModelType> modelClass, LoadProvider<ModelType, ImageVideoWrapper, GifBitmapWrapper,
        GlideDrawable> loadProvider, Glide glide, RequestTracker requestTracker, Lifecycle lifecycle) {
    ...
    /**
     * Loads and displays the {@link GlideDrawable} retrieved by the given thumbnail request if it finishes before this request. Best used for loading
     * thumbnail {@link GlideDrawable}s that are smaller and will be loaded more quickly than the fullsize {@link GlideDrawable}. There are no
     ...
     * thumb {@link GlideDrawable} will never replace the full image.
     *
     ...
     * either the full {@link GlideDrawable} loads or the thumbnail loads, you need to call {@link #animate(int)} on both the thumb and the full
     * request. For a simpler thumbnail option where these options are applied to the humbnail as well, see {@link #thumbnail(float)}. </p>
     *
    ...
    /**
     * Transform {@link GlideDrawable}s using the given {@link com.bumptech.glide.load.resource.bitmap.BitmapTransformation}s.
     *
     * <p> Note - Bitmap transformations will apply individually to each frame of animated GIF images and also to individual {@link Bitmap}s. </p>
     *
    ...
    /**
     * Transform {@link GlideDrawable}s using the given {@link android.graphics.Bitmap} transformations. Replaces any previous transformations.
     *
     * @return This request builder.
     * @see #fitCenter()
     * @see #centerCrop()
